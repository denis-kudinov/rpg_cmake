...
#include "mylib/AnimationComponent.hpp"
...
bool AnimationComponent::play(const std::string& key, float dt, bool priority)
{
...
bool AnimationComponent::play(const std::string& key, float dt, float modifier, float modifier_max, bool priority)
{
	if (this->priorityAnimation) //If there is a priority animation
	{
		if (this->priorityAnimation == this->animations[key])
