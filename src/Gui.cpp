...
unsigned gui::calcCharSize(const sf::VideoMode& vm, unsigned modifier)
{
	/*
...
void gui::DropDownList::update(const sf::Vector2i& mousePosWindow, float dt)
{
...
//Accessors
bool gui::TextureSelector::getActive() const
{
	return this->active;
}
...
void gui::TextureSelector::update(const sf::Vector2i& mousePosWindow, float dt)
{
	this->updateKeytime(dt);
