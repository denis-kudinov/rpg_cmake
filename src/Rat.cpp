...
void Rat::update(float dt, sf::Vector2f& mouse_pos_view, const sf::View& view)
{
...
void Rat::render(sf::RenderTarget& target, sf::Shader* shader, const sf::Vector2f& light_position, bool show_hitbox)
{
	if (shader)
	{
