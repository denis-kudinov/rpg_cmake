...
unsigned Enemy::getGainExp() const
{
	return this->gainExp;
}
...
void Enemy::generateAttributes(unsigned level)
{
...
void Enemy::update(float dt, sf::Vector2f& mouse_pos_view, const sf::View& view)
{
