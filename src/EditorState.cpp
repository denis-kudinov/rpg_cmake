...
{
	std::ifstream ifs("Resources/Config/editorstate_keybinds.ini");
...
void EditorState::updatePauseMenuButtons()
{
	...
	if (this->pmenu->isButtonPressed("SAVE"))
		this->tileMap->saveToFile("Resources/text.slmp");

	if (this->pmenu->isButtonPressed("LOAD"))
		this->tileMap->loadFromFile("Resources/text.slmp");
}
