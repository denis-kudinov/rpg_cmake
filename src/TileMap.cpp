...
bool TileMap::tileEmpty(int x, int y, int z) const
{
...
//Functions
void TileMap::addTile(int x, int y, int z, const sf::IntRect& texture_rect, bool collision, short type)
{
...
bool TileMap::checkType(int x, int y, int z, int type) const
{
	return this->map[x][y][this->layer].back()->getType() == type;
}

void TileMap::updateWorldBoundsCollision(Entity* entity, float dt)
{
	//WORLD BOUNDS
...
void TileMap::updateTileCollision(Entity* entity, float dt)
{
	//TILES
	this->layer = 0;
...
void TileMap::updateTiles(Entity* entity, float dt, EnemySystem& enemySystem)
{
	//TILES
	this->layer = 0;
