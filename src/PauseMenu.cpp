	...
	: font(font)
{
	...
	this->menuText.setPosition(
		(this->container.getPosition().x + this->container.getSize().x / 2.f - this->menuText.getGlobalBounds().width / 2.f) - 25 ,
		this->container.getPosition().y + gui::p2pY(4.f, vm) + 50
	);
}
...
void PauseMenu::setMenuText(std::string text)
{
