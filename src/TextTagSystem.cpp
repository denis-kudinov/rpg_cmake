...
#include "mylib/TextTagSystem.hpp"
...
void TextTagSystem::addTextTag(unsigned tag_type, float pos_x, float pos_y, int i, const std::string& prefix = "", const std::string& postfix = "")
{
	std::stringstream ss;
	ss << prefix << " " << i << " " << postfix;
	this->tags.push_back(new TextTag(this->tagTemplates[tag_type], pos_x, pos_y, ss.str()));
...
void TextTagSystem::addTextTag(unsigned tag_type, float pos_x, float pos_y, float f, const std::string& prefix = "", const std::string& postfix = "")
{
	std::stringstream ss;
	ss << prefix << " " << f << " " << postfix;
	this->tags.push_back(new TextTag(this->tagTemplates[tag_type], pos_x, pos_y, ss.str()));
...
void TextTagSystem::update(float dt)
{
