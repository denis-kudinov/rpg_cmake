...
//Functions
std::string RegularTile::getAsString() const
{
	std::stringstream ss;
...
void RegularTile::render(sf::RenderTarget& target, sf::Shader* shader, sf::Vector2f player_position)
{
	if (shader)
	{
