...
private:
	...
	public:
		...
		//Accessor
		inline bool isExpired() const { return this->lifetime <= 0.f; }
...
public:
	...
	void addTextTag(unsigned tag_type, float pos_x, float pos_y, int i, const std::string& prefix, const std::string& postfix);
	void addTextTag(unsigned tag_type, float pos_x, float pos_y, float f, const std::string& prefix, const std::string& postfix);
